...
#define LSM6DSO_INT1_PIN	23
#define LSM6DSO_INT2_PIN	22
#define LSM6DSO_SDA_PIN		25
#define LSM6DSO_SCL_PIN		24
...
#define STD_VARIANCE_THRES_DEF        0.15f  	 // for Standard Deviation
