...
void load_model(void)
{
	...
	uint8_t model_data[65] = 
	{
		...
		// 0x##, 0x##, ..., 0x##
		0x40,
		0xAC,0x80,0xB5,0xB0,0xB8,0x50,0xBA,0x60,0xBC,0x00,
		0xBD,0x50,0xBE,0x80,0xBF,0xB0,0xC1,0x30,0xC2,0xD0,
		0xC5,0x40,0xC7,0xE0,0xCB,0x00,0xCE,0x40,0xD3,0x50,
		0xD8,0xB0,0x01,0x80,0x07,0x10,0x10,0x70,0x0F,0xE0,
		0x18,0x20,0x14,0xC0,0x16,0x80,0x0F,0xF0,0x10,0x80,
		0x08,0x80,0x09,0x10,0x08,0x80,0x09,0x00,0x08,0x20,
		0x06,0x10,0x06,0x10
	};
