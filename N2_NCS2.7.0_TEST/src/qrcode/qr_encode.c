...
** Last modified Date:          
** Last Version:		   
** Descriptions:		   	ʹ�õ�ncs�汾-1.9.0		
** Created by:				л��
** Created date:			2023-01-31
** Version:			    	1.0
** Descriptions:			��ά��������C�ļ�(����ԭ����� http://coolshell.cn/articles/10590.html#jtss-tsina)
******************************************************************************************************/
#include "string.h"
#include "QR_Encode.h"
#include "LCD.h"
...
#define QR_CODE_DOT_PIXEL_MIN	4
#define QR_CODE_DOT_PIXEL	4
